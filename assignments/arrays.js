...
let lastCar = 0;
console.log('The last car in the inventory is a ${inventory[inventory.lenght-1].car_make} ${inventory[inventory.lenght-1].car_model}');
...
const result = carYears.filter(carYears => carYears<2000);
